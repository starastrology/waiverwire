...
urlpatterns = [
    ...
    path('sortcomments', views.sort_comments, name='sort_comments'),
    path('deletenotification', views.delete_notification, name='delete_notification'),
    path('deleteallnotifications', views.delete_all_notifications, name='delete_all_notifications'),
    #path('sortfas', views.sort_fas, name='sort_fas'),
    path('proposals/trades', views.trade_proposals, name='trade_proposals'),
    path('proposals/callups', views.callup_proposals, name='callup_proposals'),
    path('proposals/options', views.option_proposals, name='option_proposals'),
    path('proposals/signings', views.signing_proposals, name='signing_proposals'),
    ...
    path('proposals/signing/create', views.create_signing_proposal, name='create_signing_proposal'),
    path('proposals/signing/submit', views.submit_signing_proposal, name='submit_signing_proposal'),
    ...
    path('WaiverClaims', views.waiver_claims, name='waiver_claims'),
    ...
    path('<str:location>/<str:name>/WaiverClaims', views.team_waiver_claims, name='team_waiver_claims'),
